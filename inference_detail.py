...
def main():
    ...
    dirs = {
        "raw_refined": os.path.join(output_dir, "1_model_output"),
        "collage": os.path.join(output_dir, "2_visualization_collage"),
        "overlay": os.path.join(output_dir, "3_overlay_comparison"),
        "facets": os.path.join(output_dir, "4_facet_polygons")
    }
